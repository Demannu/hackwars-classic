...
public class TextDecorationRenderState implements RenderState {
	private RenderState prevRenderState;
	...
	public int getTextDecorationMask() {
		int parentMask = this.prevRenderState.getTextDecorationMask();
