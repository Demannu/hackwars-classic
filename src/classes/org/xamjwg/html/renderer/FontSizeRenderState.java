...
public class FontSizeRenderState implements RenderState {
	private final RenderState prevRenderState;
	private final int fontSize;
	private final int fontStyle;
	
	public FontSizeRenderState(RenderState prevRenderState, int fontSize, int fontStyle) {
	...
	public Font getFont() {
		...
		f = parentFont.deriveFont((float) this.fontSize);
