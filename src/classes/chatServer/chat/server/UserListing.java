...
public class UserListing {
    ...
    public User loadUser(String uniqueName, String uniqueNick, sql s) throws Exception{
        try{
            ...
            u = SQLUser.getSqlData(s, uniqueName, this);
            if(u != null){
               this.addUser(u);
            ...
            u = SQLUser.createUser(s, uniqueName, uniqueNick, this);
    ...
    public void removeUser(String uniqueName, sql s) throws Exception{
        ...
        if(u == null){
            throw new Exception("Could not log out user, Could not find user <" +uniqueName+ ">");
        }
